...
import javax.swing.*;
public class assig3 extends JApplet
{
	public void init()
	{
		setContentPane(new Panel());
	}
	private static JFrame frame=new JFrame("TOWER OF HANOI - SUDHEESH SINGANAMALLA");
	private static JPanel panel2=new JPanel();
	private static JPanel panel1=new JPanel();
	private static JTextField text=new JTextField("",4);
	private static JLabel label=new JLabel("ENTER THE NUMBER OF DISKS (1-9)");
	...
	public static class Panel extends JPanel implements ActionListener
	{
		...
		public void recur(int ak,int bk,int ck,int disk_num)
		{
			...
			if(disk_num>=0)
			{
				...
				//set the previous disk place as background color
